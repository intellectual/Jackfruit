...
for path, name in zip(filePaths,fileNames):
    ...
    if img is None:
        ...
        if name.startswith('AM') or name.startswith('BM') or name.startswith('m'):
            dstPath = '/Users/pradeep/Desktop/Hackathon/Face Recognition/May2014Training/males94/'
        else:
            dstPath = '/Users/pradeep/Desktop/Hackathon/Face Recognition/May2014Training/females94/'
